...
class AppConfigConstants {
  // Name of app
  static String appName = 'Dropout';

  static String currentVersion = '1.7';
  static const liveAppLink = 'https://www.ericfranzee.com/';

  static String appTagline = 'Share your day activity with friends';
  static const googleMapApiKey = 'your_google_map_api_key';

  static const restApiBaseUrl = 'https://ericfranzee.com/api/web/v1/';

  // Socket api url
  static const socketApiBaseUrl = "https://ericfranzee.com:4000/";
